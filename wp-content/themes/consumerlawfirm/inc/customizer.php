...
function tora_customize_register( $wp_customize ) {
   ...
   $controls = array(  
        ...
        'header_text' => array(
            ...
            'default'       => __('An elegant business theme','tora'),
            'type'          => 'text',
        ...
        'body_fonts' => array(
            'slug'          => 'body_fonts',
            'section'       => 'tora_fonts',
            'sanitize'      => 'tora_sanitize_fonts',
            'default'       => '<link href=\'https://fonts.googleapis.com/css?family=Lato:400,400italic,700,700italic\' rel=\'stylesheet\' type=\'text/css\'>',
            'type'          => 'text',
        ...
        'headings_fonts' => array(
            ...
            'section'       => 'tora_fonts',
            'sanitize'      => 'tora_sanitize_fonts',
            'default'       => '<link href=\'https://fonts.googleapis.com/css?family=Raleway:400,600\' rel=\'stylesheet\' type=\'text/css\'>',
            'type'          => 'text',
...
//Fonts
function tora_sanitize_fonts( $input ) {
