...
function tora_scripts() {
	...
	$body_font 		= get_theme_mod('body_fonts', '<link href=\'https://fonts.googleapis.com/css?family=Lato:400,400italic,700,700italic\' rel=\'stylesheet\' type=\'text/css\'>');
	$headings_font 	= get_theme_mod('headings_fonts', '<link href=\'https://fonts.googleapis.com/css?family=Raleway:400,600\' rel=\'stylesheet\' type=\'text/css\'>');
	...
	wp_enqueue_style( 'tora-body-fonts', esc_attr($body_url) ); 
	
	wp_enqueue_style( 'tora-headings-fonts', esc_attr($headings_url) ); 
	...
	wp_enqueue_script( 'tora-wow', get_template_directory_uri() . '/js/wow.min.js', array('jquery'), '', true );
 ...
 * Enqueue Animate CSS
 */
function tora_enqueue_animate_css() {
	wp_enqueue_style( 'tora-animate-css', get_template_directory_uri() . '/css/animate.css', array(), true );
}
add_action( 'wp_enqueue_scripts', 'tora_enqueue_animate_css', 9 );


/**
 * Enqueue Custom CSS
 */
function tora_enqueue_custom_css() {
	wp_enqueue_style( 'custtom-css', get_template_directory_uri() . '/css/main.css', array(), true );
}
add_action( 'wp_enqueue_scripts', 'tora_enqueue_custom_css', 9 );

/**
 * Load html5shiv
 */
function tora_html5shiv() {
    echo '<!--[if lt IE 9]>' . "\n";
    echo '<script src="' . esc_url( get_template_directory_uri() . '/js/html5shiv.js' ) . '"></script>' . "\n";
    echo '<![endif]-->' . "\n";
}
add_action( 'wp_head', 'tora_html5shiv' );
