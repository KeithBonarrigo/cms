...
function tora_live_composer_defaults( $options, $id ) {
    ...
    if ( $id == 'DSLC_Accordion' ) { 
        $new_defaults = array(
            ...
            'accordion_nav' => 'CLICK TO EDIT  (dslc_sep)  CLICK TO EDIT',
    ...
    if ( $id == 'DSLC_Tabs' ) { 
        $new_defaults = array(
            'tabs_content' => 'This is just placeholder text.  (dslc_sep)  This is just placeholder text.  (dslc_sep)  This is just placeholder text.',
            'tabs_nav' => 'Click to edit  (dslc_sep)  Click to edit title  (dslc_sep)  Click to edit title',
